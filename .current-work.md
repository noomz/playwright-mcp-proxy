...
- [ ] get_content(ref_id) returns only content changed since last call for that ref_id
...
- [ ] Diff algorithm: simple string comparison (before/after snapshots)
- [ ] Console logs do NOT implement diff (always return full logs for ref_id)
